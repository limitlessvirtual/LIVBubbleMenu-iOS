...
-(void)show
{
    if(!_isAnimating)
    {
        ...
        float bubbleSpacingAngle = 360 / _menuItemImages.count;
        float angleY = (float) ((180 - bubbleSpacingAngle) * 0.5);
        float startAngle = 180 - angleY;
        ...
        for (int i = 0; i < bubbleButtons.count; ++i)
        {
            ...
            float angle = startAngle + i * bubbleSpacingAngle;
